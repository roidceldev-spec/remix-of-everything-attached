    ...
    <div className="break-words text-sm">
      ...
      <Dialog>
        <DialogTrigger asChild>
          <button
            type="button"
            className="mt-1 block font-medium text-blue-500 underline-offset-4 hover:underline focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
            placeholder
          </button>
        </DialogTrigger>
